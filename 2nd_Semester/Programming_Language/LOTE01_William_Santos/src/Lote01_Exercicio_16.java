...
public class Lote01_Exercicio_16 
{
    public static void main (String args[])
    {
        ...
        double proventos, percentual, sal_liquido;
        ...
        percentual = Double.parseDouble(JOptionPane.showInputDialog("Digite a o percentual de desconto: "));
        descendentes = Integer.parseInt(JOptionPane.showInputDialog("Digite o número de descendentes que possui: "));
        
        sal_liquido = (proventos + (descendentes * 100)) - (proventos/100 * percentual);
